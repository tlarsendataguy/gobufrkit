...
func TestUnexpandedTemplate_Expand(t *testing.T) {
	...
	assertEqual(t, et.Dump(), `301001 301001
    001001 001001
    001002 001002
301013 301013
    004003 004003
...
func TestUnexpandedTemplate_Expand2(t *testing.T) {
	...
	et, _ := ut.Expand(group)
	assertEqual(t, et.Dump(), `103002 103002
    001001 001001
    001002 001002
    004003 004003`)
}
...
func TestUnexpandedTemplate_Expand4(t *testing.T) {
	...
	et, _ := ut.Expand(group)
	assertEqual(t, et.Dump(), `103000 103000
....031001 031001
    301001 301001
        001001 001001
        001002 001002
...
func TestExpandedTemplate_Walk(t *testing.T) {
	...
	for e := range et.Walk(ins) {
		if e.Descriptor != nil {
			assertEqual(t, fmt.Sprintf("%v,%v", e.Code, e.Descriptor.Id()), events[i])
		} else {
			assertEqual(t, fmt.Sprintf("%v,<nil>", e.Code), events[i])
		}
		i += 1
	}
	close(ins)
